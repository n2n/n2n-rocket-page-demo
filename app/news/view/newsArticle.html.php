...
<article class="news-article">
	<h1 class="news-article-title display-3"><?php $html->out($newsArticle->getTitle()) ?></h1>
		...
		<div class="news-author row align-items-center">
			<div class="col-3">
				<?php if (null !== $authorImg = $newsAuthor->getFoto()): ?>
					<?php $html->image($authorImg, ThSt::crop(160, 160), array('class' => 'img-fluid rounded-circle', 'alt' => 'Team Member')) ?>
				<?php endif ?>
			</div>
			<div class="col-9">
...
<?php $html->linkToController(array('comment', $newsArticle->getId()), $html->getText('add_comment'), array('class' => 'btn btn-primary')) ?>
